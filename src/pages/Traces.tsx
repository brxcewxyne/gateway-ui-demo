...
export function Traces() {
  ...
  return (
    <div>
      <PageHead eyebrow="Observability" title="Request Traces" sub="Why did the gateway choose this model? Click any row for the visual timeline."
...
export function TraceDetail() {
  ...
  return (
    <div>
      <PageHead eyebrow="Observability" title={`Request #${t.id}`} sub={`${t.app} · ${t.team} · ${t.time}`}
