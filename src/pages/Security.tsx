        ...
        <div className="card p-4">
          ...
          {policies.map(p => (
            <div key={p.id} className="border-t border-[#1a2230] py-2 first:border-0">
              ...
              <div className="mono text-[11.5px] text-[#8d99ae]">{p.rule}</div>
              <div className="text-[11.5px] text-[#8d99ae]">{p.scope} · {p.effect}</div>
            </div>
          ))}
        </div>
        <div className="card p-4">
          ...
          <div className="text-[12px] text-[#8d99ae] mt-2">Every block links to its trace for proof.</div>
        </div>
        <div className="card p-4">
          ...
          {approvals.map(a => (
            <div key={a.id} className="border-t border-[#1a2230] py-2 first:border-0">
              ...
              <div className="text-[12px] text-[#8d99ae]">{a.app} · {a.risk} risk · {a.detail}</div>
